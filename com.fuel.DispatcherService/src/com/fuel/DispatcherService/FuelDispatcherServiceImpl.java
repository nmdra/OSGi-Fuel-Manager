...
public class FuelDispatcherServiceImpl implements FuelDispatcherService {
    ...
    public double calculateByRupees(double rupees) {
        ...
        System.out.println("");
        System.out.println("");
        System.out.println("For Rs. " + rupees + ", you will get " + calculatedLiters + " liters of " + selectedFuelType);
        System.out.println("");
        System.out.println("");
        System.out.println("");
        System.out.println("");
...
//        System.out.println("Before Update - Fuel Stock: " + fuel.getAvailableLiters() + " liters");
        ...
        System.out.println("After Update - Fuel Stock: " + FuelStorage.getFuelType(selectedFuelType).getAvailableLiters() + " liters");

        Transaction transaction = new Transaction(pumpNumber, selectedFuelType, calculatedCost, calculatedLiters, calculatedCost);
