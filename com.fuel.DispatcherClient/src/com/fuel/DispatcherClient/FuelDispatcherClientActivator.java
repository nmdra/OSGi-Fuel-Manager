...
public class FuelDispatcherClient implements BundleActivator {
...
//    public FuelDispatcherClient(BundleContext context) {
//        ServiceReference<?> reference = context.getServiceReference(FuelDispatcherService.class.getName());
//        fuelDispatcherService = (FuelDispatcherService) context.getService(reference);
//    }
    ...
    public void start(BundleContext context) throws Exception {
        ...
        if (reference != null) {
            ...
            System.out.println("💥 Fuel Disptcher available.");
        } else {
            System.out.println("⚠️ Fuel Dispacther not available.");
        }
        startClient();
    }
